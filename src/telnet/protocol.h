#ifndef RJ_NET_TELNET_PROTOCOL_H
#define RJ_NET_TELNET_PROTOCOL_H
...
namespace rj
{
    namespace net
    {
        namespace telnet
        {
            ...
            constexpr static const socket::data_type DATA_MARK = 242;  //    The data stream portion of a Synch.This
            ...
            constexpr static const socket::data_type SB =
                250;  //    Indicates that what follows is subnegotiation of the indicated option.
            constexpr static const socket::data_type WILL = 251;  //    Indicates the desire to begin performing, or
            ...
            constexpr static const socket::data_type DO =
                253;  //    Indicates the request that the  other party perform, or confirmation that you
                      //    are expecting  the other party to perform, the indicated option.
            constexpr static const socket::data_type DONT =
                254;  //    Indicates the demand that the other party stop performing, or confirmation
