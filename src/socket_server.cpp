...
namespace coda {
  namespace net {
    ...
    socket_server::socket_server(socket_server &&other) noexcept
        : socket(std::move(other)), factory_(other.factory_),
    ...
    void
    socket_server::set_socket_factory(const factory_type &factory) noexcept {
      factory_ = factory;
    }
    ...
    socket_server::socket_type socket_server::on_accept(SOCKET socket,
